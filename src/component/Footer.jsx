...
const Footer = () => {
  return (
   <>
        <footer className="text-gray-400 bg-sky-900 body-font">
  <div className="container px-5 py-24 mx-auto">
    <div className="grid grid-cols-4 place-items-center lg:grid-cols-3 sm2:grid-cols-2 sm:grid-cols-1 md:text-left text-center -mb-10 -mx-4">
    ...
    <div className="container px-5 py-8 flex flex-wrap mx-auto items-center">
      {/* <div className="flex md:flex-nowrap flex-wrap justify-center items-end md:justify-start">
        <div className="relative sm:w-64 w-40 sm:mr-4 mr-2">
          <label htmlFor="footer-field" className="leading-7 text-sm text-gray-400">Search Product</label>
  ...
  <div className="bg-sky-800 bg-opacity-75">
    <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
      <p className="text-gray-400 text-sm text-center sm:text-left">© 2023 shopclues —
        <a href="https://twitter.com/knyttneve" className="text-gray-500 ml-1" target="_blank" rel="noopener noreferrer">@mashirulhaque</a>
      </p>
